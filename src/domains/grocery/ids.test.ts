...
describe("grocery ids: every primary-key brand rejects the empty string", () => {
  const PK_SCHEMAS = { GroceryIngredientUidSchema, GroceryItemUidSchema, GroceryListUidSchema };
