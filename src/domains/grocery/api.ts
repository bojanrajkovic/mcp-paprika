 ...
 * touch them, and both reach them via `ctx.state`, never a cross-domain contract.
 *
 * So there is nothing to expose: this contract is `{}` until a future coordinator or
 * diagnostic surface actually needs grocery state. The three stores and caches stay
 * private behind it.
 */
