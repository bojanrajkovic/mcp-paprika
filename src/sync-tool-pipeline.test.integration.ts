...
// exercise that path end-to-end; AC5 still drives the legacy SyncEngine directly (its
// per-module reconcile coverage moves to the kernel in the deferred #20 sync-coverage pass).
