...
/**
 * Browser entry for the grocery-checklist widget. The mount bootstrap (read the inlined ext-apps
 ...
 */
mountWidget({ name: "paprika-grocery-checklist", version: "1.0.0" }, App);
