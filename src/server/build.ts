...
- The aisle and meal-type catalogs are fully manageable: new entries appear automatically when an item or meal names an unknown aisle/type; update_aisle / update_meal_type rename and reorder (meal types also recolor); delete_aisle refuses while items still reference the aisle, while delete_meal_type proceeds and the referencing meals just show no type.
