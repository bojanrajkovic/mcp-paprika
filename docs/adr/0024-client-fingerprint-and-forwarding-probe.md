...
- Issue: #358.
- External: the Model Context Protocol initialize handshake — `clientInfo`, `protocolVersion`, and the client capability set (`roots` / `sampling` / `elicitation` / `experimental`).
